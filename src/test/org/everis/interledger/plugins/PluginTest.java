...
class PluginTest {
    ...
    void setUp() {
        ...
        bankOfIngland.addAccount(new LocalAccount("connectorEveris" , "connectorEveris" , 1000));
        bankOfLepe   .addAccount(new LocalAccount("connectorEveris" , "connectorEveris" , 1000));
        ...
        plugin1 = new Plugin(bankOfIngland, new Plugin.LedgerConnection("connectorEveris", "connectorEveris", CONNECTOR_ADDRESS));
        plugin2 = new Plugin(bankOfLepe   , new Plugin.LedgerConnection("connectorEveris", "connectorEveris", CONNECTOR_ADDRESS));
        ...
        try {
            Plugin pluginWrongCredentials = new Plugin(
                    ...
                    new Plugin.LedgerConnection(
                            "connectorEveris", "hacker_from_Lepe_Trying_To_Connect_With_this_Wrong_Password", CONNECTOR_ADDRESS));
    ...
    void sendTransfer() {
        ...
        InterledgerAddress srcAccount = InterledgerAddress.of(LEDGER1_PREFIX+"user1_2");
        InterledgerAddress dstAccount = InterledgerAddress.of(LEDGER1_PREFIX+"user1_2");
        ...
        int   final_holdBalance = bankOfIngland.getHoldAccount().getBalance();
        assertEquals(initial_holdBalance + amount, final_holdBalance);
    }
