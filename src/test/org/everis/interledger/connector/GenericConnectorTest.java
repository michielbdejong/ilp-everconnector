...
////@BeforeEach
////void setUp() {
////    //instance of the connector with the id connector use for build the ilp ilpAddress for the connector accounts
...
////    pluginBankEngland = new PaymentChannelPlugin(bankOfEngland, new LedgerConnectionConfig(ID_CONNECTOR_EVERIS, "password", CONNECTOR_ADDRESS));
////    pluginBankFrance = new PaymentChannelPlugin(bankOfFrance   , new LedgerConnectionConfig(ID_CONNECTOR_EVERIS, "password", CONNECTOR_ADDRESS));
